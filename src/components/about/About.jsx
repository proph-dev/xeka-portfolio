...
export const About = () => {
    return (
        <section className='relative h-full py-8 laptop:py-0 laptop:h-screen' id='about' >
            <div className="content flex items-center justify-between flex-col laptop:flex-row h-full">
                <div className='w-full laptop:w-1/2 px-8 semiTablet:px-20 py-12 rounded-sm shadow-2xl'>
