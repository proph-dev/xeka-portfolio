    ...
    return (
        <section className='relative h-screen'>
            <div className="content flex flex-col items-center">
                ...
                {/* Projects */}
                <div className='grid grid-cols-3 gap-32 mt-16'>
                    {projects.map((project) => {
                        return (
                            <article key={ project.id } className='shadow-lg hover:shadow-2xl hover:scale-105 duration-300 ease rounded-2xl h-96 w-[18vw] min-w-[190px] overflow-hidden'>
